...
Для того, чтобы вставляемые данные были максимально приближены к реальным использовался пакет Faker, который имеет много встроенных стратегий генерации тестовых данных (адреса, email, числа, текст, имена и так далее)
